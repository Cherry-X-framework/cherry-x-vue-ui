...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200615_vertos_613fa3251f6578232215_20220417190545_archive.zip';
	const ARCHIVE_SIZE		 = '87461755';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '613fa32-17190545';
    const SECONDARY_PACKAGE_HASH = 'f85796e-17190545';
	const VERSION			 = '1.4.5';
